        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current text-black bg-[#EDFFEF] border rounded-full p-2 w-10 h-10 "
            >
          ...
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current bg-[#39DB4A] text-white border rounded-full p-2 w-10 h-10"
            >
